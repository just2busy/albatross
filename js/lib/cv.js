// basically c&p of jsfeat/sample_orb until lib is pared down for specific needs
var ComputerVision = (function(){
    ...
    var options, num_train_levels = 4;
    var width, height;
    ...
    function train_pattern() {
        ...
        jsfeat.imgproc.gaussian_blur(lev0_img, lev_img, 0); // this is more robust
        ...
        for(lev = 1; lev < num_train_levels; ++lev) {
            ...
            jsfeat.imgproc.gaussian_blur(lev_img, lev_img, 0);
            corners_num = detect_keypoints(lev_img, lev_corners, max_per_level);
            jsfeat.orb.describe(lev_img, lev_corners, corners_num, lev_descr);
    ...
    function preConfigure(imageWidth, imageHeight, difficulty) {
        ...
        screen_descriptors = new jsfeat.matrix_t(32, options.number_points|500, jsfeat.U8_t | jsfeat.C1_t);
        pattern_descriptors = [];
        screen_corners = [];
        pattern_corners = [];
        matches = [];
        ...
        match_mask = new jsfeat.matrix_t(options.number_points|500,1,jsfeat.U8C1_t);
    }
    ...
    function describeImage() {
        ...
        num_corners = detect_keypoints(img_u8_smooth, screen_corners, options.number_points|500);
    ...
    function getMatches() {
        ...
        return { 
            ...
            maxPossibleMatches: screen_descriptors.rows,
            idealMaxMatches: pattern_descriptors
        };
    }
